...
@Entity // Hibernate Linking
public class User {
    
    @Id     //To make the Value Unique
    @GeneratedValue(strategy = GenerationType.IDENTITY) // it will generate the Id of the User in a sequence for AutoIncrementation of the values
    @Column(length = 10,name = "user_id")
    private int userId;
    @Column(length = 100,name = "user_name") // length here is the size in the database table and name is the table name in the database for respective Column
