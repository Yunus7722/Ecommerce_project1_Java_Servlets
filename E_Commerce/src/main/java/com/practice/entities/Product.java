...
public class Product {
    ...
    private int pRatings;
    @ManyToOne
    private Category category;

    public Product(String pName, String pDesc, String pPhoto, int pPrice, int pDiscount, int pQuantity, int pRatings, Category category) {
        this.pName = pName;
        this.pDesc = pDesc;
        this.pPhoto = pPhoto;
        this.pPrice = pPrice;
    ...
    public Product(int pId, String pName, String pDesc, String pPhoto, int pPrice, int pDiscount, int pQuantity, int pRatings, Category category) {
        this.pId = pId;
        this.pName = pName;
        this.pDesc = pDesc;
        this.pPhoto = pPhoto;
    ...
    public int getpRatings() {
        return pRatings;
    }

    public void setpRatings(int pRatings) {
        this.pRatings = pRatings;
    }
